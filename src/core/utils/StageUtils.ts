...
module core {
    export class StageUtils extends BaseClass {
        //UIStage单例
        private static _uiStage:LayerCenter;
        ...
        public constructor() {
            ...
            if (StageUtils._uiStage == null) {
                StageUtils._uiStage = LayerCenter.Instance;
            }
        }
        ...
        public startFullscreenAdaptation(designWidth: number, designHeight: number): void {
