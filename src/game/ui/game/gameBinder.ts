...
module game {
	...
	export class gameBinder{
		public static bindAll():void {
			...
			fairygui.UIObjectFactory.setPackageItemExtension(UI_Btn_xx.URL, UI_Btn_xx);
			...
			fairygui.UIObjectFactory.setPackageItemExtension(UI_Btn_normal.URL, UI_Btn_normal);
			...
			fairygui.UIObjectFactory.setPackageItemExtension(UI_Btn_share.URL, UI_Btn_share);
			fairygui.UIObjectFactory.setPackageItemExtension(UI_Btn_star.URL, UI_Btn_star);
		}
	}
}