...
(function (game) {
    var UI_TopUI = (function (_super) {
        ...
        UI_TopUI.prototype.constructFromXML = function (xml) {
            ...
            this.m_btn_home = (this.getChildAt(2));
            this.m_btn_sound = (this.getChildAt(3));
            this.m_btnrefresh = (this.getChildAt(4));
            this.m_btn_pause = (this.getChildAt(5));
            this.m_img_star = (this.getChildAt(6));
            this.m_txt_star = (this.getChildAt(7));
        };
