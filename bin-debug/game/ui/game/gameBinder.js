...
(function (game) {
    var gameBinder = (function () {
        ...
        gameBinder.bindAll = function () {
            ...
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Btn_xx.URL, game.UI_Btn_xx);
            ...
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Btn_normal.URL, game.UI_Btn_normal);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Alert.URL, game.UI_Alert);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Good.URL, game.UI_Good);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Cool.URL, game.UI_Cool);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Btn_refresh.URL, game.UI_Btn_refresh);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Btn_sound.URL, game.UI_Btn_sound);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_BtnStart.URL, game.UI_BtnStart);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_GameMenuModule.URL, game.UI_GameMenuModule);
            fairygui.UIObjectFactory.setPackageItemExtension(game.UI_Btn_home.URL, game.UI_Btn_home);
