...
(function (game) {
    var UI_ChangePanel = (function (_super) {
        ...
        UI_ChangePanel.prototype.constructFromXML = function (xml) {
            ...
            this.m_content3 = (this.getChildAt(14));
            this.m_content2 = (this.getChildAt(15));
            this.m_content1 = (this.getChildAt(16));
            this.m_add1 = (this.getChildAt(17));
            this.m_add2 = (this.getChildAt(18));
            this.m_add3 = (this.getChildAt(19));
            this.m_list = (this.getChildAt(20));
            this.m_btn_del1 = (this.getChildAt(21));
            this.m_btn_del2 = (this.getChildAt(22));
            this.m_btn_del3 = (this.getChildAt(23));
        };
